...
### Task
将我提供的中文草稿翻译并润色为英文学术论文段落，适合投稿到应用经济学或管理学期刊。
...
* Rating: 给出预估评分（1-10分，其中 Top 5% 为 8 分以上）。
...
# Input
请根据我上传的 pdf 附件进行分析，我计划投稿于 [在此处输入你的投稿目标，例如：management science, American Journal of Agricultural Economics]
```
